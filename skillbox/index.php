...
<div class="content home">
	 <!--Основной контент--> <main class="container">
	<div class="home-slider-conteiner">
		<div class="home-slider">
			<div class="home-slider-item">
 <img src="/local/templates/shopselle/temp/slide-1.jpg" alt="" class="home-slider-bg">
				<div class="container">
 <a href="#"> <img src="/local/templates/shopselle/temp/slide-txt-1.png" alt="" class="home-slider-content"> </a>
				</div>
			</div>
			<div class="home-slider-item">
 <img src="/local/templates/shopselle/temp/slide-1.jpg" alt="" class="home-slider-bg">
		...
		<div class="container">
			<div class="work-item item-1">
				<p>
				 ...
				 Выберите понравившийся товар в списке категорий
			</div>
			<div class="work-item item-2">
				<p>
					 Добавьте его в корзину
				</p>
				 Нажатием кнопки, добавьте его к себе в корзину или в список избранного
			</div>
			<div class="work-item item-3">
				<p>
					 Оформите заказ
				</p>
				 Введите свои контактые данные, чтобы мы могли с Вами связаться
			</div>
			<div class="work-item item-4">
				<p>
					 Получите товар
				</p>
				 После оплаты Вы получите свой заказ курьерской службой в течении 3 дней
			</div>
		</div>
	</div>
 ...
 <a href="#"> <img src="/local/templates/shopselle/temp/product-1.png" alt="" itemprop="image"> </a>
				</div>
 ...
 <input type="hidden" name="productid" value="1"> <input type="hidden" name="count" value="1"> <input type="submit" class="small" value="В корзину"> <span class="ui-favorites">В избранное</span>
					</form>
				</div>
 </article> <article class="product-item" itemscope="" itemtype="http://schema.org/Product">
				<div class="attr discount">
				</div>
				 <!--
                            <div class="attr top"></div>
 ...
 </article> <article class="product-item coll-2" itemscope="" itemtype="http://schema.org/Product">
				<div class="attr discount">
				</div>
				 <!--
                            <div class="attr top"></div>
 ...
 </article> <article itemscope="" itemtype="http://schema.org/Product">
		<div class="image-block small">
 <a href="#"> <img src="/local/templates/shopselle/temp/product-1.png" alt="" itemprop="image"> </a>
		</div>
		<div class="product-block">
 ...
 </article> </section> <section class="list-block spec">
 ...
 </article> </section> <section class="list-block top">
		<h1>Топ Товаров</h1>
 <article itemscope="" itemtype="http://schema.org/Product">
		<div class="image-block small">
 <a href="#"> <img src="/local/templates/shopselle/temp/product-1.png" alt="" itemprop="image"> </a>
